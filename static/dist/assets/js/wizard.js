...
function validateFirstStep(){
    ...
    $(".wizard-card form").validate({
		rules: {
			...
			surname: "required",
            salutation: "required",
            registrationqualifications: "required",
...
*/			
		...
		messages: {
			profile_image: "Please supply a photo or logo",
            firstname: "Please enter your first name",
			surname: "Please enter your last name",
            salutation: "Please select your salutation",
            registrationqualifications: "Please supply a registration",
            companyname: "Please enter an organisation name",
