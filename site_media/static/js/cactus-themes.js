...
jQuery(document).ready(function(e) {
	...
	// mobile menu 2
	jQuery('.mobile-menu-toggle2').click(function(e) {
		jQuery('body').toggleClass('enable-mobile-menu2');
		jQuery('body').removeClass('scroll-mobile-menu2');
    });
	jQuery('.mobile-menu2').scroll(function(e) {
        jQuery('body').addClass('scroll-mobile-menu2');
    });
